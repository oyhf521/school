...
public abstract class Assert
{
	...
	{
		if (!expression) { throw new RRException(message); }
	}
	...
	{
		if (StringUtil.isNotEmpty(text)) { throw new RRException(message); }
	}
	...
	{
		if (StringUtil.isEmpty(text)) { throw new RRException(message); }
	}
	...
	{
		if (StringUtil.isNotBlank(text)) { throw new RRException(message); }
	}
	...
	{
		if (StringUtil.isBlank(text)) { throw new RRException(message); }
	}
	...
	{
		if (CollectionUtils.isEmpty(collection)) { throw new RRException(message); }
	}
	...
	{
		if (CollectionUtils.isEmpty(array)) { throw new RRException(message); }
	}
	...
	{
		if (CollectionUtils.isEmpty(map)) { throw new RRException(message); }
	}
